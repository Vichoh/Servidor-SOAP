...
public class EstructuraPaginaWebPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "EstructuraPaginaWeb";
	...
	private EstructuraPaginaWebPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new EstructuraPaginaWebPersistentManager();
		}
